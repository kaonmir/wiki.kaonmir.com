...
Linux 파일은 16 bit로 접근 권한을 관리합니다. 4bit는 [[파일의 종류]] (-,d,c,b,s,l,p)에, 3bit는 특수권한에 사용합니다.
...
### /etc/shadow 명령을 o+x를 하면 모든 사용자가 실행할 수 있지 않아? 왜 굳이 u+s를 해야 해?
...
### 일반 사용자가 Root 권한을 얻어서 실행한다면 다른 사용자의 비밀번호도 바꿀 수 있지 않나요?
